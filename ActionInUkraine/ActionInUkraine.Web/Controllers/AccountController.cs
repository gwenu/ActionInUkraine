...
namespace ActionInUkraine.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            ...
            {
                ResendConfirmationEmail(model.Email);
        ...
        private void SendEmailConfirmation(string to, string username, string confirmationToken)
        {
            ...
            email.ConfirmationLink = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Host + ":" + HttpContext.Request.Url.Port + "/Account/" + "RegisterConfirmation/" + confirmationToken;
            email.Send();
        }
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    ...
                    string confirmationToken =
                        WebSecurity.CreateUserAndAccount(model.Email, model.Password, model.FirstName, model.SecondName, model.Gender, model.DOB, true);
                    SendEmailConfirmation(model.Email, model.FirstName, confirmationToken);
        ...
        public ActionResult ResetPassword(ResetPasswordModel model)
        {
            ...
            if (!string.IsNullOrEmpty(emailAddress))
            {
                ...
                email.ConfirmationToken = confirmationToken;
                email.ConfirmationLink = HttpContext.Request.Url.Scheme + "://" + HttpContext.Request.Url.Host + ":" + HttpContext.Request.Url.Port + "/Account/" + "ResetPasswordConfirmation/" + confirmationToken;
                email.Send();
        ...
        public ActionResult Manage(ManageMessageId? message)
        {
            ...
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Пароль встановлено"
        ...
        public ActionResult ExternalLoginConfirmation(RegisterExternalLoginModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                try
                {
                    WebSecurity.CreateUser(new UserProfile() { Email = model.UserName });
